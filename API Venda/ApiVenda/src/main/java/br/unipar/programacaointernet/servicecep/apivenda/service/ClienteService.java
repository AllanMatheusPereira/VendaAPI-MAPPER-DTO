...
import br.unipar.programacaointernet.servicecep.apivenda.mapper.NomeTelefoneAniversarioClienteMapper;
...
public class ClienteService {
   ...
   /* private void deletar(Integer id) throws Exception {
    ...
    public List<NomeTelefoneAniversarioClienteDTO> listarClienteAniversario() {
        List<Cliente> listCliente= clienteRepository.listar();
        return NomeTelefoneAniversarioClienteMapper.toDTO(listCliente);
    }
}
